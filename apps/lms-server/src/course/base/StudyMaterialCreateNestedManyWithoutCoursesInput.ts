...
@InputType()
class StudyMaterialCreateNestedManyWithoutCoursesInput {
...
export { StudyMaterialCreateNestedManyWithoutCoursesInput as StudyMaterialCreateNestedManyWithoutCoursesInput };
