...
export class CourseResolverBase {
  ...
  async createCourse(@graphql.Args() args: CreateCourseArgs): Promise<Course> {
    return await this.service.createCourse({
      ...
      data: {
        ...
        studyMaterial: args.data.studyMaterial
          ? {
              connect: args.data.studyMaterial,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [StudyMaterial], { name: "studyMaterials" })
  @nestAccessControl.UseRoles({
  ...
  async findStudyMaterials(
    ...
    const results = await this.service.findStudyMaterials(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => StudyMaterial, {
    nullable: true,
    name: "studyMaterial",
  })
  @nestAccessControl.UseRoles({
  ...
  async getStudyMaterial(
    ...
    const result = await this.service.getStudyMaterial(parent.id);
